...
const AUDIT_GROUPS: AuditGroup[] = [
  { key: 'today',    label: 'Today',     date: new Date('2026-04-23'), events: [
    ...
    { id: 'evt-4',  action: 'edited',    actor: { type: 'system',      name: 'BambooHR System'                                          }, northStarOnly: true, description: [{ text: 'Time Off Accrual Update', link: true }, { text: ' applied to ' }, { text: '3 employees', link: true }],                                                                                                             timestamp: '12:01 AM', details: { ipAddress: '—',            area: 'Time Off',          changes: [], automationSteps: [
  ...
  { key: 'apr-12', label: 'Apr 12',    date: new Date('2026-04-12'), events: [
    { id: 'evt-20', action: 'edited',    actor: { type: 'system',      name: 'BambooHR System'                                          }, northStarOnly: true, description: [{ text: 'Time Off Policy Update', link: true }, { text: ' applied to all employees' }],                                                                                                                              timestamp: '12:00 AM', details: { ipAddress: '—',            area: 'Time Off',          changes: [], automationSteps: [
